/**
 * Funkcije za preuzimanje podataka sa API-a
 * 
 * Ovaj modul sadrži funkcije za preuzimanje informacija o kolekcijama, proizvodima, narudžbinama i povezanim proizvodima,
 *  kao i za pretragu proizvoda na osnovu upita. 
 * Funkcije koriste `fetch` za komunikaciju sa API-jem i vraćaju podatke u JSON formatu.
 */
