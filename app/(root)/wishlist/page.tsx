...
const Wishlist = () => {
  ...
  return loading ? <Loader /> : (
    <div className="px-10 py-5">
      <p className="text-heading3-bold font-playfair my-10">Your Wishlist</p>
      <hr className="w-full border-t-2 border-gray-400 my-4" />

      {wishlist.length === 0 && (
        <p className="font-playfair text-heading3-bold text-grey-2 text-center">No items in your wishlist</p>
      )}
